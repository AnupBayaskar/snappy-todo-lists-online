          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {roles.map((role, index) => (
                <Card key={role.title} className="hover:shadow-lg transition-shadow border-0 shadow-md">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <Card className="p-8 hover:shadow-lg transition-shadow">
                  ...
                  <a href="mailto:support@governer.com" className="text-green-600 hover:underline">
                ...
                <Card className="p-8 hover:shadow-lg transition-shadow">
                  ...
                  <a href="tel:+1-555-GOVERNER" className="text-green-600 hover:underline">
                    +1 (555) GOVERNER
                  </a>
                </Card>
